...
/**
  * @brief get touch counts from underlying pads in slide device
  *
  * @param tp_slide_handle
  * @param counts array of touch counts to fill in.
  * @param ncounts number of elements in the counts array.
  * @return number of counts filled in, or -1 on error.
  */
int iot_tp_slide_counts_get(tp_slide_handle_t tp_slide_handle,
    int *counts, unsigned int ncounts);
